...
export const Navbar = () => {
  return (
    ...
    <a className="TeamderLogo navbar-brand ml-auto d-flex ms-3" href="#">
      <img src= {Logo2} alt="logo" width="30" height="30" className=" d-inline-block align-text-top"/>
      <span className="ms-2">Teamder</span>
    </a>
    ...
    <li class="nav-item dropdown me-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-circle text-info" viewBox="0 0 16 16">
