const getState = ({
    ...
    return {
        ...
        actions: {
            ...
            getActivities: async () => {
                await fetch(
                        "https://3001-miguelubeda-teamder-7t7wawy98j3.ws-eu63.gitpod.io/api/getAllActivities"
                    )
                    .then((resp) => {
                        if (resp.ok) {
            ...
            login: (infouserpass) => {
                const response = fetch(
                        "https://3001-miguelubeda-teamder-7t7wawy98j3.ws-eu63.gitpod.io/api/token", {
                            //mode: 'no-cors',
                            method: "POST",
            ...
            signup: async (infouserpassw) => {
                await fetch(
                    "https://3001-miguelubeda-teamder-7t7wawy98j3.ws-eu63.gitpod.io/api/signup", {
                        method: "POST",
            ...
            addActivity: async (infouserpassw) => {
                ...
                await fetch(
                    "https://3001-miguelubeda-teamder-7t7wawy98j3.ws-eu63.gitpod.io/api/addActivity", {
                        method: "POST",
                        body: JSON.stringify(infouserpassw),
                        headers: {
                            "Content-Type": "application/json",
            ...
            joinActivity: async (index) => {
                ...
                await fetch(
                    "https://3001-miguelubeda-teamder-7t7wawy98j3.ws-eu63.gitpod.io/api/joinActivity", {
                        method: "POST",
            ...
            private: async () => {
                ...
                await fetch(
                    "https://3001-miguelubeda-teamder-7t7wawy98j3.ws-eu63.gitpod.io/api/privated",
